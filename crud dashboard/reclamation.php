...
if (isset($_POST["submit"])) {
    if ($b) {
        $sql1 = "UPDATE reclamation SET etat='Traité'";
...
$stql = "SELECT * FROM reclamation WHERE id_reclamation!=0";
$table = "";
$row = $err = '';
$S = '';
...
<body>
    ...
    <form action="reclamation.php" method="post">
        ...
        while($res = mysqli_fetch_array($result)) {  
            ...
            <td> <?php echo $res['reclamation'] ?> </td>      
            <td><?php echo $res['etat'] ?></td>
            <td>  
    <input type='submit' value='valider' name='submit' 
    class="<?php if($res["etat"] == "Traité")
    {echo "btn-success btn";}
    else{echo "btn-danger btn";} ?>">
            </td>
             </tr>  
        <?php } ?>
