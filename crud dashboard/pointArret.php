...
if (isset($_POST["add"])) {
    ...
    if ($b) {
        $sql1 = "INSERT INTO point_arret (nom_point) VALUES ('$nom')";
...
<body>
    <form action="pointArret.php" method="POST">
        <div class="wrapper">
                                ...
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
                                            <h2 class="ml-lg-2">Gestion des Point Arret</h2>
                                        </div>
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                                            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
                                                <i class="material-icons">&#xE147;</i> <span>Ajouter un point arret</span></a>
        ...
        while($res = mysqli_fetch_array($result)) {  
            ...
            echo "<td> <a href=\"updatePointArret.php?id_point=$res[id_point]\">Modifier</a>  | <a href=\"deletePointArret.php?id_point=$res[id_point]\" onClick=\"return confirm('Are you sure you want to delete?')\">Supprimer</a></td>";  
             echo "</tr>";  
        }
        ?>
                                </table>
                                        ...
                                        <div class="modal-content">
                                            <form action="pointArret.php" method="POST">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Ajouter un point arret</h4>
