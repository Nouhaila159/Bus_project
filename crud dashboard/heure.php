...
if (isset($_POST["add"])) {
    $heure = $_POST["heure"];
    if ($b) {
        $sql1 = "INSERT INTO horaire (heure) VALUES ('$heure')";
...
if (isset($_POST['supprimer'])) {
    $id = $_SESSION['id'];
    $sql3 = "DELETE FROM heure where id_heure='$id'";
    mysqli_query($mysqli, $sql3);
    
}

 $stql = "SELECT * FROM horaire WHERE id_heure!=0";
...
<body>
    ...
    <form action="ligne.php" method="post">
        <div class="wrapper">
                                ...
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
                                            <h2 class="ml-lg-2">Gestion des horaires</h2>
                                        </div>
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
                                            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal">
                                                <i class="material-icons">&#xE147;</i> <span>Ajouter heure</span></a>
                                            <a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal">
                                                <i class="material-icons">&#xE15C;</i> <span>Supprimer heure</span></a>
                                        </div>
                                    </div>
                                </div>
            ...
            echo "<td>".$res['id_heure']."</td>";
            echo "<td>".$res['heure']."</td>";         
            echo "<td> <a href=\"updateHeure.php?id_heure=$res[id_heure]\">Modifier</a> | <a href=\"deleteHeure.php?id_heure=$res[id_heure]\" onClick=\"return confirm('Are you sure you want to delete?')\">Supprimer</a></td>";  
             echo "</tr>";  
        }
                                    ?>
                                        ...
                                        <div class="modal-content">
                                            <form action="heure.php" method="POST">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Ajouter une heure</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Heure</label>
                                                        <input name="heure" type="time" class="form-control" required="required">
                                                    </div>
                                                </div>
