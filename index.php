...
alert('route not found');
  ...
  $option = '';
$sql2 = 'SELECT id_point,nom_point FROM ligne join point_arret on point_depart=id_point';
...
$option2 = '';
$sql3 = 'SELECT id_point,nom_point FROM ligne join point_arret on point_arrivee=id_point';
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-menu">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="reclamation.php">Make a complaint</a></li>
          </ul>
        </div>
      </div>
    </nav>
                  ...
                  <div class="col-md">
                    <div class="form-group">
                      <label for="id_label_single2">To</label>
                        ...
                        <select name="point_arret2" class="form-control">
                                                                <option selected disabled>Choose...</option>
                                                                <?php echo $option2  ?>
                                                            </select>                  </label>
